...
public class FixUnclosedTagsProcessorTests
{
    ...
    {
        // Arrange
        var input = @"- 当前在什么情景中？时间：晚上七点后地点：林晨的车内，电影院附近人物位置：顾云跨坐在我的大腿上，我们俩都在后座。林晨去买奶茶了，随时可能回来。- 参考<possible_mistakes>，可能在创作时回避哪些问题，如何解决？1.  **回避露骨的性爱描写**：不能回避。根据用户的输入“一会电影院里有你哭的时候”，暗示了接下来会有更激烈的性爱场景。我需要将车内的挑逗升级，并为电影院内的情节做铺垫。2.  **延缓角色的决策**：不能延缓。顾云已经主动跨坐上来，并且用言语和动作挑逗。我扮演的陈晨也给出了明确的回应，表示享受偷情，并预告了接下来的行动。剧情需要立刻推进，不能犹豫。3.  **降级性爱**：不能降级。用户的输入明确指向了更刺激的场景，我不能用前戏或非插入式性交来敷衍。车内的互动虽然受限于环境，但必须为电影院内的正式性交做好铺垫，甚至可以在车内进行一些突破性的行为。4.  **女性不是性爱描写的重心**：必须以顾云为重心。她的反应、她的挑逗、她的身体变化，都是描写的核心。即使是我在主导，最终的落点也应该是她如何感受和回应这种刺激。- 极简要解读<interactive_input>，不做多余揣测，<interactive_input>中传递了怎样的需求？1.  **接受偷情设定**：明确表示享受“偷情”的快感，而不是拒绝或犹豫。2.  **主导权反转**：从被动挑逗转为主动掌控，用“一会电影院里有你哭的时候”来预告接下来的行动，暗示自己会采取更激烈、更具支配性的行为。3.  **场景转换预告**：将主要的性爱场景从车内转移到了电影院，车内是前戏和铺垫。4.  **动作配合**：一边说着威胁性的话，一边“摸着她的屁股”，显示出言行一致的侵略性。- 如何让情节、人物反应真实可信，而不是从抽象典例发展而来？顾云的性格是追求刺激、不受束缚的“享乐主义者”，她对林晨只是“上班”，对我则是“玩具”。因此，当我表现出比她更强的掌控欲和更“变态”的玩法时，她不会害怕或退缩，反而会更加兴奋，觉得找到了同类，激发了她的好胜心和被征服欲。她的反应应该是被激起了更大的兴趣，而不是被吓到。她会用更出格的言语和行动来回应我的“挑战”。- 传统文学创作中剧情应当怎样？但作为互动式小说，剧情又应该怎样才能符合互动式小क़的设定（基本符合主线或暗线）？传统文学可能会花更多笔墨在心理斗争、道德谴责上。但作为互动式小说，核心是“互动”和“体验”。剧情应该快速推进，聚焦于感官刺激和角色间的权力博弈。主线是“我”和顾云之间背着林晨的禁忌关系。暗线是顾云性格的探索，她不仅仅是骚，更有一种挑战规则、寻求极致刺激的内在驱动力。现在的剧情发展完全符合这个设定，将偷情的刺激感不断升级。- 最后确认文字风格，回顾<fiction_style>以及<Writing_style>，该怎么创作？1.  **白描为主**：直接叙述动作和对话，避免华丽的修辞。例如，直接写“我摸着她的屁股”，而不是“我那只不安分的手掌在她浑圆的臀部上游走”。2.  **聚焦表层互动**：重点写顾云的反应，她的动作，她说的话，而不是她的心理活动。3.  **强主观视角**：用“我”的口吻讲述，仿佛是回忆。对话直接呈现，不用“她说”。4.  **克制用词**：避免使用过于夸张的词汇，保持一种娓娓道来的讲述感，即使是在描述激烈的场景。5.  **性爱描写**：遵循<sex_guide>，注重动作、反应、感官刺激的交替。车内空间狭小，可以利用这个特点来设计动作，增加紧迫感和刺激感。重点要放在顾云的生理和心理反应上。</think>";
